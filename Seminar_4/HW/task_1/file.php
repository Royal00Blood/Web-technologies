...
$works = [
  ...
  [
    'name_work' => 'Engineer',
      ...
      'description' => 'I make robots',
  ],
  [
    'name_work' => 'Designer',
      'date_start' => 'June 1990',
      'date_end' => 'February 2008',
      'description' => 'I draw pictures',
  ],
];
?>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $works [$i]["name_work"]?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works [$i]["date_start"]?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $works [$i]["date_end"]?></span></h6>
