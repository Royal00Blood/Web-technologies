...
const temp = Number.parseInt(prompt("Enter temperature in degrees Celsius:"));

alert(`Цельсий: ${temp}, Фаренгейт:  ${convertToFarenget(temp).toFixed(2)}`)

function convertToFarenget(number) {
